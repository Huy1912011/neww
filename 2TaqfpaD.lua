...
do -- Example UI
	local Window = library:AddWindow("YOUTUBE: ALI BOSS - 07/03/2023", {
		main_color = Color3.fromRGB(0, 0, 0),
		min_size = Vector2.new(350, 350),
		toggle_key = Enum.KeyCode.RightShift,
		can_resize = true,
	})
	local Tab = Window:AddTab("MENU NEW")

	do -- Elements
	
	Tab:AddLabel("XIN CHAO ANH EM BLOX FRUITS VIET NAM")
	Tab:AddLabel("~ DANH SACH MENU SCRIPT ALI BOSS ~")
		Tab:AddButton("OPEN MENU - SHEESH ", function()
			loadstring(game:HttpGetAsync('https://sharetext.me/raw/u3if6m3hgr'))()
		end)
		
end
	local Tab = Window:AddTab("   MOD 1  ")
 
	do -- Elements
		Tab:AddLabel("CHIA SE SCRIPT NAY CHO BAN BE NHA")
	    Tab:AddLabel("~ DANH SACH MENU SCRIPT ALI BOSS ~")
		
				Tab:AddButton("NHAY CAO", function()
			                loadstring(game:HttpGet("https://pastebin.com/raw/ZTRKSzaP"))()
		end)
			Tab:AddButton("CHAY NHANH", function()
			        loadstring(game:HttpGet("https://pastebin.com/raw/5pngPZjp"))()
		end)
	
		Tab:AddButton("FARM DF", function()
			loadstring(game:HttpGet("https://raw.githubusercontent.com/IceMael7/NewIceHub/main/Brookhaven"))()
		end)
	
		Tab:AddButton("HACK TOC DANH", function()
	...
	Tab:AddButton("DO HOA 4K", function()
			        loadstring(game:HttpGet("https://pastebin.com/raw/fMHgDVD7", true))()
		end)
	
end

local Tab = Window:AddTab("   MOD TỰ TẠO  ")
 
	do -- Elements
		Tab:AddLabel("CHIA SE SCRIPT NAY CHO BAN BE NHA")
	    Tab:AddLabel("~ DANH SACH MENU SCRIPT ALI BOSS ~")
		
				Tab:AddButton("XETER", function()
